...
//         <h1 className="text-3xl font-bold text-gray-800 mb-6">Research Details</h1>
...
//                 <p className="font-medium text-gray-800">{patent.areaOfResearch}</p>
...
//                 <p className="font-medium text-gray-800">
//                   {[patent.author1, patent.author2, patent.author3, patent.author4]
//                     .filter(Boolean)
//                     .join(", ")}
//                 </p>
//               </div>
...
//                 <p className="font-medium text-gray-800">{publication.publicationType}</p>
...
//                 <p className="font-medium text-gray-800">{publication.doi || "N/A"}</p>
...
//               <div className="mt-8 pt-8 border-t border-gray-200">
//                 <h2 className="text-xl font-semibold text-gray-800 mb-4">Conferences and Journals</h2>
...
//                       <p className="font-medium text-gray-800">{conference.journalName}</p>
//                       <p className="text-sm text-gray-500">Issue No</p>
//                       <p className="font-medium text-gray-800">{conference.issueNo || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Volume</p>
//                       <p className="font-medium text-gray-800">{conference.volume || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Year of Publication</p>
//                       <p className="font-medium text-gray-800">{conference.yearOfPublication}</p>
//                       <p className="text-sm text-gray-500">Page No</p>
//                       <p className="font-medium text-gray-800">{conference.pageNo || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Authors</p>
//                       <p className="font-medium text-gray-800">
//                         {[conference.author1, conference.author2, conference.author3, conference.author4]
//                           .filter(Boolean)
//                           .join(", ")}
//                       </p>
//                       <p className="text-sm text-gray-500">Published Under</p>
//                       <p className="font-medium text-gray-800">{conference.publishedUnder || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Impact Factor</p>
//                       <p className="font-medium text-gray-800">{conference.impactFactor || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Quartile</p>
//                       <p className="font-medium text-gray-800">{conference.quartile || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Sponsor</p>
//                       <p className="font-medium text-gray-800">{conference.sponsor || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Venue</p>
//                       <p className="font-medium text-gray-800">{conference.venue}</p>
//                       <p className="text-sm text-gray-500">From Date</p>
//                       <p className="font-medium text-gray-800">{conference.fromDate}</p>
...
//                 {/* Research Grants */}
//                 <div className="mt-8 pt-8 border-t border-gray-200">
//                   <h2 className="text-xl font-semibold text-gray-800 mb-4">Research Grants</h2>
...
//                         <p className="font-medium text-gray-800">{grant.sanctionedDate}</p>
//                         <p className="text-sm text-gray-500">Project Period</p>
//                         <p className="font-medium text-gray-800">{grant.projectPeriod}</p>
//                         <p className="text-sm text-gray-500">Amount Sanctioned</p>
//                         <p className="font-medium text-gray-800">{grant.amountSanctioned}</p>
...
//                         <p className="font-medium text-gray-800">{grant.principalInvestigator}</p>
//                         <p className="text-sm text-gray-500">Co-Principal Investigator</p>
//                         <p className="font-medium text-gray-800">{grant.coPrincipalInvestigator || "N/A"}</p>
//                         <p className="text-sm text-gray-500">PhD Awarded</p>
//                         <p className="font-medium text-gray-800">{grant.phdAwarded ? "Yes" : "No"}</p>
...
//               {/* Consultancy */}
//               <div className="mt-8 pt-8 border-t border-gray-200">
//                 <h2 className="text-xl font-semibold text-gray-800 mb-4">Consultancy</h2>
...
//                     <div key={index} className="mb-4">
//                       <p className="text-sm text-gray-500">Sanctioned Date</p>
//                       <p className="font-medium text-gray-800">{consultancy.sanctionedDate}</p>
//                       <p className="text-sm text-gray-500">Project Period</p>
//                       <p className="font-medium text-gray-800">{consultancy.projectPeriod}</p>
//                       <p className="text-sm text-gray-500">Amount</p>
//                       <p className="font-medium text-gray-800">{consultancy.amount}</p>
//                       <p className="text-sm text-gray-500">Principal Investigator</p>
//                       <p className="font-medium text-gray-800">{consultancy.principalInvestigator}</p>
//                       <p className="text-sm text-gray-500">Co-Principal Investigator</p>
//                       <p className="font-medium text-gray-800">{consultancy.coPrincipalInvestigator || "N/A"}</p>
//                       <p className="text-sm text-gray-500">Status</p>
//                       <p className="font-medium text-gray-800">{consultancy.status}</p>
//                     </div>
//                   ))
//                 ) : (
...
export default function ResearchProfile() {
  ...
  const [editMode, setEditMode] = useState({}); // Tracks edit state for each section
  ...
  useEffect(() => {
    async function fetchResearchDetails() {
      try {
        ...
        if (!response.ok) {
          router.push(`/faculty/faculty_reg/profile/research-details?facultyId=${facultyId}`);
          return;
        }
  ...
  const handleSave = async (section : any) => {
    try {
      const response = await fetch(`/api/update${section}`, {
        ...
        body: JSON.stringify(researchDetails[section]),
      });
      ...
      setResearchDetails((prev) => ({ ...prev, [section]: updatedData }));
  ...
  const renderField = (value : any, onChange : any, type = "text") => (
    <input
      type={type}
      value={value || ""}
      onChange={onChange}
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg">
        ...
        {/* Research Identifiers */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {["orcidId", "googleScholarId", "scopusId", "publonsId", "researchId"].map(
            (field) => (
              <div className="space-y-1" key={field}>
                <p className="text-sm text-gray-500">{field.replace(/([A-Z])/g, " $1")}</p>
                {editMode[field] ? (
                  renderField(
                    researchDetails[field],
                    (e) =>
        ...
        {[
          { section: "patent", title: "Patents" },
          { section: "publications", title: "Publications" },
          { section: "conferenceandjournal", title: "Conferences and Journals" },
          { section: "researchGrant", title: "Research Grants" },
          { section: "consultancy", title: "Consultancy" },
        ].map(({ section, title }) => (
          <div key={section} className="mt-8 pt-8 border-t border-gray-200">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">{title}</h2>
            <button
              onClick={() => handleEditClick(section)}
              className="text-sm text-blue-500 underline mb-4"
            >
              {editMode[section] ? "Cancel" : "Edit"}
            </button>
            {editMode[section] ? (
              <div>
                {researchDetails[section].map((item, index) => (
                  <div key={index} className="mb-4">
